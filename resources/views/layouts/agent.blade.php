        ...
        <nav class="navbar-mobile">
            <div class="container-fluid">
                <ul class="navbar-mobile__list list-unstyled">
                    ...
                    <li>
                        <a href="chart.html">
                            <i class="fas fa-chart-bar"></i>Charts45</a>
                    </li>
                    <li>
                        <a href="table.html">
                ...
                <ul class="list-unstyled navbar__list">
                    <li class="active has-sub">
                        ...
                        <ul class="list-unstyled navbar__sub-list js-sub-list">
                            <li>
                                <a href="{{route('agents.dashboard')}}">Dashboard</a>
                            </li>
                    ...
                    <li class="has-sub">
                        <a class="js-arrow" href="#">
                            <i class="fas fa-copy"></i>Dossiers</a>
                        <ul class="list-unstyled navbar__sub-list js-sub-list">
                            <li>
                                <a href="{{route('dossiers.selectionnes')}}">Dossiers sélectionnés</a>
                            </li>
                            <li>
                                <a href="{{route('dossiers.valides')}}">Dossiers validés</a>
                            </li>
                    ...
                    <li class="has-sub">
                        ...
                        <ul class="list-unstyled navbar__sub-list js-sub-list">
                            <li>
                                <a href="login.html">Configuration</a>
                            </li>
                        </ul>
                    </li>
                                        ...
                                        <div class="account-dropdown__footer">
                                            <a href="#">
                                                <form action="{{route('logout')}}" method="post">
                                                    @csrf
                                                    <button type="submit"> <i class="zmdi zmdi-power"></i> Deconnexion</button>
                                                </form>
                                            </a>
                                        </div>
                                    </div>
