                                                    ...
                                                    <td>
                                                        <div class="table-data-feature">
                                                            <form action="{{route('dossier.selection', $dossier->id)}}" method="post">
                                                                ...
                                                                @if($dossier->statut_validation) <button type="submit" class="btn btn-success">Validé</button> @endif

                                                                @if(!($dossier->statut_validation))<button type="submit" class="btn btn-danger">Non Validé</button> @endif
                                                            </form>
